...
ifeq ($(filter all, $(TARGET_COMMON_QTI_COMPONENTS)),all)
...
# Define component variants based on board platform
...
# Include component makefiles based on selected components
