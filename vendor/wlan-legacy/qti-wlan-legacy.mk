...
ifeq ($(QC_WIFI_HIDL_FEATURE_DUAL_STA),true)
  ifeq ($(QC_WIFI_HIDL_FEATURE_DUAL_AP),true)
    WIFI_HAL_INTERFACE_COMBINATIONS ?= {{{STA}, 1}, {{AP, AP_BRIDGED}, 1}}, {{{STA}, 1}, {{P2P, NAN}, 1}}, {{{STA}, 2}}, {{{AP}, 2}}, {{{AP_BRIDGED}, 1}}
  else
    WIFI_HAL_INTERFACE_COMBINATIONS ?= {{{STA}, 1}, {{AP}, 1}}, {{{STA}, 1}, {{P2P, NAN}, 1}}, {{{STA}, 2}}
  endif
else ifeq ($(QC_WIFI_HIDL_FEATURE_DUAL_AP),true)
  WIFI_HAL_INTERFACE_COMBINATIONS ?= {{{STA}, 1}, {{AP, AP_BRIDGED}, 1}}, {{{STA}, 1}, {{P2P, NAN}, 1}}, {{{AP}, 2}}, {{{AP_BRIDGED}, 1}}
endif
