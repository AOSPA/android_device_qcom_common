...
ifeq ($(TARGET_USE_QTI_AIDL_HEALTH),true)
...
PRODUCT_COPY_FILES += $(QCOM_COMMON_PATH)/vendor/charging/init.charging_service.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/init.charging_service.rc
endif
