...
echo 8500000 8500000 8500000 5000000 5000000 > /proc/sys/walt/sched_util_busy_hyst_cpu_ns
echo 1 1 1 15 15 > /proc/sys/walt/sched_util_busy_hyst_cpu_util
...
echo 1075200 0 0 0 0 > /proc/sys/walt/input_boost/input_boost_freq
...
echo 1113600 > /sys/devices/system/cpu/cpufreq/policy3/walt/hispeed_freq
