...
$(warning Building for kernel $(TARGET_KERNEL_VERSION). Only copying init.aospa.perf.soc.rc of the device/qcom/common/vendor/init/$(TARGET_BOARD_PLATFORM)/etc folder.)
PRODUCT_COPY_FILES += \
